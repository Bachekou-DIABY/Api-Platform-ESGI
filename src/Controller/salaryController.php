...
class SalaryController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        if ($salaryForm->isSubmitted() && $salaryForm->isValid()) {
            ...
            //3.Calcul du salaire net avant impôt pour un.e alternant.e
            //(contrat « alternance ») avec la cotisation salariale et le coût employeur
            ...
            //4.Calcul du salaire net avant impôt pour un « cdd »
            //avec la cotisation salariale, le coût employeur et l’indemnité de fin de contrat
